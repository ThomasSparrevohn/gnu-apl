...
#define BUILDTAG PACKAGE_NAME, PACKAGE_VERSION " / cmake", "2026-04-28 08:10:00 UTC", "macOS 20 core Apple M1 Ultra", "cmake -S . -B <builddir>"
...
/* --bindir */
#define apl_DIR__bin "/tmp/apl/bin"

/* --datarootdir */
#define apl_DIR__datarootdir "/tmp/apl/share"

/* --docdir */
#define apl_DIR__doc "/tmp/apl/share/doc/GnuAPL"

/* --exec_prefix */
#define apl_DIR__exec_prefix "/tmp/apl"

/* --libdir */
#define apl_DIR__lib "/tmp/apl/lib"

/* --localedir */
#define apl_DIR__locale "/tmp/apl/share/locale"

/* installation directory for GNU APL libraries */
#define apl_DIR__pkglib "/tmp/apl/lib/apl"

/* --prefix */
#define apl_DIR__prefix "/tmp/apl"

/* top-level GNU APL source directory */
#define apl_DIR__src "/Users/sparrevo/projects/gnu-apl/src"

/* --sysconfdir */
#define apl_DIR__sysconf "/tmp/apl/etc"
...
#define apl_TARGET_ERLANG 1

/* Define if building libapl.so */
#define apl_TARGET_LIBAPL 1

/* Define if building lib_gnu_apl.so */
#define apl_TARGET_PYTHON 1
...
#define cfg_PERFORMANCE_COUNTERS_WANTED 1

/* Define to have support for rational numbers (EXPERIMENTAL!) */
#define cfg_RATIONAL_NUMBERS_WANTED 1
