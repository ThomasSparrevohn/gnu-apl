...
#define BUILDTAG PACKAGE_NAME, PACKAGE_VERSION " / SVN: Unversioned directory", "2014-01-04 12:14:00 UTC", "", "default ./configure options"
...
#define cfg_CONFIGURE_ARGS "./configure  '--build=x86_64-linux-gnu' '--prefix=/usr' '--includedir=${prefix}/include' '--mandir=${prefix}/share/man' '--infodir=${prefix}/share/info' '--sysconfdir=/etc' '--localstatedir=/var' '--disable-option-checking' '--disable-silent-rules' '--libexecdir=${prefix}/lib/apl' '--disable-maintainer-mode' '--disable-dependency-tracking' 'build_alias=x86_64-linux-gnu'"
